...
package com.example.ivi.example.customization.frontendcoordinationrule.test
...
import com.example.ivi.example.customization.frontendcoordinationrule.CustomActivity
import com.example.ivi.example.customization.frontendcoordinationrule.R
...
internal class FrontendCoordinationRuleTest : E2eTestCase(customActivity) {
    ...
    override fun waitForUiReady() {
        waitForView(withIdReference(R.id::example_customization_menu_container))
