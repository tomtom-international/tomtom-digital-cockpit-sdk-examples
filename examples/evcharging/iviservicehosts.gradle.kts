 ...
 * ```
 *
 * The preceding example obtains the `androidAppSourceProviderServiceHost` property as defined in this
...
val exampleEvChargingServiceHost by extra {
    IviServiceHostConfig(
        serviceHostBuilderName = "ExampleEvChargingServiceHostBuilder",
        implementationModule = ExampleModuleReference("examples_evcharging_service"),
        interfaces = listOf(
            IviServiceInterfaceConfig(
                serviceName = "EvChargingService",
                serviceId = "com.example.ivi.example.evcharging.service",
