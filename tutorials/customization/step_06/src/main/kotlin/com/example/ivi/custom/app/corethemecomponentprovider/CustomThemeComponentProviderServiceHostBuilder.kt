...
class CustomThemeComponentProviderServiceHostBuilder : SimpleIviServiceHostBuilder() {

    override fun createIviServices(
        iviServiceHostContext: IviServiceHostContext
    ): Collection<AnyIviServiceBase> =
        listOf(
            CustomThemeComponentProviderService(iviServiceHostContext) {
                getDiscoverableServiceIdWithIndex(it, 0)
            },
        )
